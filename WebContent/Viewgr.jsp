...
try
{
	...
	{		
			...
			rss=stt.executeQuery("select * from members where user='"+name+"' and gname='"+gname+"'");
				while(rss.next())
				{		
	...
	%>
	<tbody>
<tr><td><%=id%></td><td><%=gname%></td><td><img src="image.jsp?id=<%=id%>" width="100px" height="50px"></td><td><a href="addmembers.jsp?gname=<%=gname%>"><%=approve %></a></td></tr>

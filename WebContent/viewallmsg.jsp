                ...
                <tr style="background-color:rgb(44, 126, 194);color:white;">
                           ...
                           <th><b><font face="Tahoma" color="#303030">TYPE </font></b></th>
                            ...
                            <th><b><font face="Tahoma" color="#303030">Date</font></b></th>
                             ...
                             <th><b><font face="Tahoma" color="#303030">ACTION</font></b></th>
                    </tr>
                    </thead>
                    <%while(rs.next())
                      {
                    ...
                    <tr> 
                            ...
                            <td><b><font face="Tahoma" color="#996633" size="2"><a href="viewdcrpty.jsp">View</a></font></b><br><b><font face="Tahoma" color="#996633" size="2"><a href="request.jsp?id=<%=id%>&fmsg=<%=fmsg%>">Request Key</a></font></b></td>
